...
Komponenty tvoří pohledy (angl. views), které jsou zobrazeny jako elementy ve webové aplikaci. Tyto komponenty využívají služby (angl. services), které zajišťují funckcionalitu která není přímo vázaná na pohledy. Služby je tak tedy možné znovu použít na více místech v aplikaci.
