...
V dnešní době převažuje digitální provedení jelikož přináší větší přehlednost, jednoduší manipulaci a hlavně možnost připojovat k jednotlivým kartám podrobnější popis, komentáře, obrázky a další dokumenty. Nicméně fyzická varianta má výhodu v tom, že je stále na očích a nelze ji ignorovat. Může taktéž podněcovat k vetší komunikaci mezi týmy a to jsou důvody proč tuto variantu využívají například ve společnosti Optimizely\footnote{Optimizely: \url{https://www.optimizely.com/about/}}~\cite{kanboard-atlassian}.


%todo transparetnost a další výhody https://www.planview.com/resources/articles/kanban-101/

Díky přehlednému vyobrazení získávají jednotliví členové týmu lepší přehled o prací svých kolegů. Kanban svou podstatou dokáže poukázat na problematické procesy, které zpomalují celkový chod výroby či vývoje~\cite{bib:kanban-and-scrum}.

% @todo popsat WIP limit
