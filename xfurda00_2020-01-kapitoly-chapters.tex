...
Populárním zástupcem tradičních metodik je například vodopádový model (znázorněný diagramem~\ref{img:waterfall}), na kterém je na první pohled patrné dříve zmiňované sekvenční řazení jednotlivých procesů vývoje.
...
% @todo negativa jako motivace a uvod pro agilni metody

\subsection{Agilní řízení projektů}
Agilní metodiky řízení projektů jsou \blindtext
...
\blindtext % is most suitable for projects which involve uncertainty and constant change
