...
\projectinfo{
  ...
  % Abstrakt / Abstract
  abstract.cs={Cílem této práce bylo vytvořit webovou aplikaci typu Kanban dle požadavků společnosti SEACOMP s.r.o. @todo}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
